...
import LaboratoireInfo from './LaboratoireInfo';
// import { formatCityToLabelValue } from '../../../containers/Laboratoires/add/utils';
const styles = theme => ({
  root: {
...
export function AddLaboratoireFrom(props) {
  const {
    // cities,
    editMode,
    classes,
...
AddLaboratoireFrom.defaultProps = {};

AddLaboratoireFrom.propTypes = {
...
export default withStyles(styles)(AddLaboratoireFrom);
