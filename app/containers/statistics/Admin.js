        ...
        <Grid container spacing={24}>
          <Grid item lg={3} md={12} sm={12} xs={12}>
            <div className={classes.container}>
              <Card
                title="Utilisateurs"
                items={[{ label: 'Total', value: statistics.totalUsers }]}
                backgroundColor="#50DFB3"
              />
              <div style={{ marginBottom: '10px' }} />
              <Card
                title="Offres"
                items={[{ label: 'Total', value: statistics.totalOffre }]}
                backgroundColor="#FF8F67"
              />
              <div style={{ marginBottom: '10px' }} />
              <Card
                title="Laboratoires"
                items={[{ label: 'Total', value: statistics.totalLabos }]}
          ...
          <Grid item lg={6} md={12} sm={12} xs={12}>
            ...
            <div className={classes.container}>
              <PieChart
                data={
                  statistics.caparRegion
                    ? statistics.caparRegion.map(v => v.value)
                    : []
                }
                labels={
                  statistics.caparRegion
                    ? statistics.caparRegion.map(v => v.name)
                    : []
                }
          ...
          <Grid item lg={3} md={12} sm={12} xs={12}>
            <div className={classes.container}>
              <Card
                title="Articales"
                items={[{ label: 'Total', value: statistics.totalArticle }]}
                backgroundColor="#FFCC3F"
              />
              <div style={{ marginBottom: '10px' }} />
              <SmallCard
                title="Nbr fournisseur"
