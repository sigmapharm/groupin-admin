...
import PharmacieListConsult from '../consultlistpharmacie/PharmacieListConsult';
...
export class PharmacieListTableRow extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  edit = ({ id }) => {
    history.push(`/pharmacies/edit/${id}`);
  ...
  render() {
    console.log('les lignes', this.props);
...
PharmacieListTableRow.defaultProps = {};

PharmacieListTableRow.propTypes = {
