...
import ProviderListConsult from '../consultlistprovider/ProviderListConsult';
...
export class ProviderListTableRow extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
  ...
  delete = () => {
    this.props.deleteProvider(this.props.row);
    this.setState({ isTippyOpen: false });
  };
...
ProviderListTableRow.defaultProps = {};

ProviderListTableRow.propTypes = {
